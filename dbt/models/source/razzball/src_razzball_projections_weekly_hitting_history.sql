...
-- Full weekly-hitting history for projection divergence (#206).
select {{ dbt_utils.star(source('razzball', 'projections_weekly_hitting')) }},
...
from {{ source('razzball', 'projections_weekly_hitting') }}
