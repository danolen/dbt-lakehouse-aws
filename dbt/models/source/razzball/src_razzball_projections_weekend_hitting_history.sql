...
-- Full weekend-hitting history for projection divergence backtests (#206).
select {{ dbt_utils.star(source('razzball', 'projections_weekly_weekend_hitting')) }},
...
from {{ source('razzball', 'projections_weekly_weekend_hitting') }}
