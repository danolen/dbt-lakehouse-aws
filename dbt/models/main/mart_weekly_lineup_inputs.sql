...
hitters as (
    select
        ...
        -- Fri–Sun components for Friday swap / split-week what-if (#187)
        cast(b.has_weekend_hitting as boolean) as has_weekend_hitting,
        cast(b.fs_num_g as int) as fs_num_g,
        cast(b.fs_home_games as int) as fs_home_games,
        cast(b.fs_away_games as int) as fs_away_games,
        cast(b.fs_vs_rhp as int) as fs_vs_rhp,
        cast(b.fs_vs_lhp as int) as fs_vs_lhp,
        b.fs_opp,
        b.fs_sp,
        cast(b.fs_hit_g as double) as fs_hit_g,
        cast(b.fs_pa as double) as fs_pa,
        cast(b.fs_ab as double) as fs_ab,
        cast(b.fs_hits as double) as fs_hits,
        cast(b.fs_r as double) as fs_r,
        cast(b.fs_hr as double) as fs_hr,
        cast(b.fs_rbi as double) as fs_rbi,
        cast(b.fs_sb as double) as fs_sb,
        cast(b.fs_bb as double) as fs_bb,
        cast(b.fs_so as double) as fs_so,
        cast(b.fs_batting_avg as double) as fs_batting_avg,
...
pitchers as (
    select
        ...
        cast(null as boolean) as has_weekend_hitting,
        cast(null as int) as fs_num_g,
        cast(null as int) as fs_home_games,
        cast(null as int) as fs_away_games,
        cast(null as int) as fs_vs_rhp,
        cast(null as int) as fs_vs_lhp,
        cast(null as varchar) as fs_opp,
        cast(null as varchar) as fs_sp,
        cast(null as double) as fs_hit_g,
        cast(null as double) as fs_pa,
        cast(null as double) as fs_ab,
        cast(null as double) as fs_hits,
        cast(null as double) as fs_r,
        cast(null as double) as fs_hr,
        cast(null as double) as fs_rbi,
        cast(null as double) as fs_sb,
        cast(null as double) as fs_bb,
        cast(null as double) as fs_so,
        cast(null as double) as fs_batting_avg,
